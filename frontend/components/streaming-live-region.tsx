 ...
 * the visible text is handled by the caller's own Markdown/Text render, which updates
 * on every chunk. Announcing every chunk would spam/garble a screen reader, so this
 * throttles what's exposed to accessibilityLiveRegion to roughly once every THROTTLE_MS
